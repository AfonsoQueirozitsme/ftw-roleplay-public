...
// Create a permissions API namespace
export namespace PermissionsAPI {
  export const {
    ...
    hasAnyPermission,
    hasAllPermissions,
  } = require('./permissions.core');
}

// Export core functions with both original and short names
export const {
  clearPermissionsCache,
  getUserPermissions,
  hasPermission,
...
export const clearCache = PermissionsAPI.clearPermissionsCache;
export const getPerms = PermissionsAPI.getUserPermissions;
export const hasPerm = PermissionsAPI.hasPermission;
export const hasAnyPerm = PermissionsAPI.hasAnyPermission;
export const hasAllPerms = PermissionsAPI.hasAllPermissions;
};
...
type RoleWithPermissions = Role & {
  role_permissions: (RolePermissionRow & {
    permissions: Pick<Permission, "identifier"> | null;
  })[] | null;
};
